...
$kihieu["cham0"][] = trim("01,10,02,20,03,30,04,40,05,50,06,60,07,70,08,80,09,90,00");
$kihieu["cham1"][] = trim("01,10,12,21,13,31,14,41,15,51,16,61,17,71,18,81,19,91,11");
$kihieu["cham2"][] = trim("02,20,12,21,23,32,24,42,25,52,26,62,27,72,28,82,29,92,22");
...
trim("00,01,02,03,04,05,10,11,12,13,14,15,20,21,22,23,24,25,30,31,32,33,34,35,40,41,42,43,44,45,50,51,52,53,54,55");

$kihieu["dal6"][] = $kihieu["dal1"][] = $kihieu["day6"][] = $kihieu["day1"][] =
trim("11,12,13,14,15,16,21,22,23,24,25,26,31,32,33,34,35,36,41,42,43,44,45,46,51,52,53,54,55,56,61,62,63,64,65,66");

$kihieu["dal7"][] = $kihieu["dal2"][] = $kihieu["day7"][] = $kihieu["day2"][] =
trim("22,23,24,25,26,27,32,33,34,35,36,37,42,43,44,45,46,47,52,53,54,55,56,57,62,63,64,65,66,67,72,73,74,75,76,77");

$kihieu["dal8"][] = $kihieu["dal3"][] = $kihieu["day8"][] = $kihieu["day3"][] =
trim("33,34,35,36,37,38,43,44,45,46,47,48,53,54,55,56,57,58,63,64,65,66,67,68,73,74,75,76,77,78,83,84,85,86,87,88");

$kihieu["dal9"][] = $kihieu["dal4"][] = $kihieu["day9"][] = $kihieu["day4"][] =
trim("44,45,46,47,48,49,54,55,56,57,58,59,64,65,66,67,68,69,74,75,76,77,78,79,84,85,86,87,88,89,94,95,96,97,98,99");
...
$kihieu["chia3du0"][] 
= trim("03,06,09,12,15,18,21,24,27,30,33,36,39,42,45,48,51,54,57,60,63,66,69,72,75,78,81,84,87,90,93,96,99");

$kihieu["chia3du1"][] 
= trim("01,04,07,10,13,16,19,22,25,28,31,34,37,40,43,46,49,52,55,58,61,64,67,70,73,76,79,82,85,88,91,94,97");

$kihieu["chia3du2"][] 
= trim("02,05,08,11,14,17,20,23,26,29,32,35,38,41,44,47,50,53,56,59,62,65,68,71,74,77,80,83,86,89,92,95,98");
